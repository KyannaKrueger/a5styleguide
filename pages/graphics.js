  ...
  return (
    <>
      ...
      <main className={`${styles.graphics} container`}>
          ...
          <div className={styles.graphicsIntroContainer}>
          <div className={styles.graphicsIntroContainer}></div>
        ...
        <div className={styles.buttonsContainer}>
          <div className={styles.buttonsFirstP}>
          ...
          <div className={styles.cardContainer}>
          <img src="/exercise info 2.png" className={styles.quizEx} />
            <img src="/exercise info 1.png" className={styles.quizEx} />
          </div>
