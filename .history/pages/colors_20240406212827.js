        ...
        <main className={styles.colors}>
         ...
         <div className={styles.swatchContainer}>
              ...
              <div className={styles.clrSwatch}>
                  ...
                  <h4>The Black</h4>
                  <p>Black is our background color for dark mode, <br/>and our text color for light mode. Black also serves to<br/> highlight the vibrant orange color and has a large contrast.</p>    
              </div>
