    ...
    return (
      ...
      <Header/>
        <main className={styles.logoPage}>
            ...
            <div className={styles.variationsTxtContainer}>
                <h5 className={styles.variationsTxt}>Original logo on Dark mode</h5>
                <h5 className={styles.variationsTxt}>Logo on Light mode</h5>
                <h5 className={styles.variationsTxtLast}>Grayscale logo</h5>
            </div>
