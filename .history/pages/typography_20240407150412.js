    ...
    return (
      ...
      <Header/>
        ...
        <p className={styles.typoText}>San Francisco Pro is an Apple-designed typeface that provides a consistent, legible, and friendly typographic voice.<br/>
              ...
              Second, SF Pro offers nine weights, including italics, and features like small caps and fractions<br/> that provide precision typesetting capabilities, ideal for presenting different information.
