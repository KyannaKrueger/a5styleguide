...
export default function Graphics() {
    return (
      ...
      <Header/>
        ...
        <p className={styles.buttonPTwo}>Human eyes are naturally drawn to curves, making rounded buttons more prominent than straight lines. Additionally,<br/> rounded buttons are considered more inclusive and accessible to users with motor impairments because they are easier to recognize and help reduce the risk of accidental touches.</p>
