...
export default function Graphics() {
    return (
      ...
      <Header/>
        ...
        <p className={styles.navP}>Icons are employed to offer users visual cues, enhancing navigation and the overall user experience. 5 primary icons are adopted to facilitate navigation at the bottom of<br/> the mobile screen.</p>
