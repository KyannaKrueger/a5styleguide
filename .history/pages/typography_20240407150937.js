    ...
    return (
      ...
      <Header/>
        ...
        <p className={styles.typoText}>San Francisco Pro is an Apple-designed typeface that provides a consistent, legible, and friendly typographic voice.<br/>
            ...
            Last, SF Pro supports for over 150 languages across various scripts ensures inclusivity for a diverse user base.<p/></p>

        <p className={styles.typoText}>In conclusion, SF Pro combines aesthetic appeal, functionality, and user experience optimization, making it an ideal typographic choice for fostering engagement and usability within our fitness app.</p>
        </main>
      </>
    );
  }
