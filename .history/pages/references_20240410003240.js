...
export default function ref() {
    return (
      ...
      <Header/>
        ...
        <h3 className={styles.refHeadings}>Color from <a href="https://m2.material.io/design/color/dark-theme.html#behavior" className={styles.refLink}>Google Material Design</a><br /><a href="https://www.ux-republic.com/en/which-border-radius-to-adopt-for-your-cta-copy/" className={styles.refLink}>Verywell mind</a></h3>
