  ...
  return (
    <>
      ...
      <main className={styles.graphics}>
        ...
        <p className={styles.badgesP}>Badges are used to track progress and acknowledge users' milestones in workout<br /> achievements. For instance, upon watching 20 Upper Body videos, users can earn a bronze badge. This system motivate<br />users to persist in their workouts, striving to earn more badges displayed within the app and share their achievements<br /> with friends.</p>
        ...
        <p className={styles.homeP}>The Rewards icon lets users navigate to the 'My Rewards' page, which features a rewards action button, users' achievements, and statistical records.<br /> This page serves as a summary of users' statistics, allowing them to overview their progress within the app. It acts as a motivational tool, encouraging<br /> users to monitor their results and redeem rewards.</p>
        </div>
        <div className={styles.pContainer}>
        <img src="/nutritionIcon.png" className={styles.homeIcon} />
        <p className={styles.homeP}>The Nutrition button directs users to the articles page featuring nutrition information. Users can browse articles and search for nutrition tips and knowledge.<br />The nutrition page goes hand in hand with our app because working out and nutrition are often linked together.</p>
        </div>
        <div className={styles.pContainer}>
        <img src="/settingsIcon.png" className={styles.homeIcon} />
        <p className={styles.homeP}>The Settings button directs users to the settings page of the app, where they can adjust their preferences and customize their accessibility settings.<br /> The range of settings offers users a more accessible and inclusive user experience.</p>
        </div>
        ...
        <p className={styles.buttonPTwo}>Human eyes are naturally drawn to curves, making rounded buttons more prominent than straight lines. Additionally,<br /> rounded buttons are considered more inclusive and accessible to users with motor impairments because they are easier<br /> to recognize and help reduce the risk of accidental touches.</p>
        <img src="/cardsExample.png" className={styles.card} />
        <img src="/roundedExample.png" className={styles.rounded} />
        <p className={styles.iconsExOne}>For the icons designed throughout the app, our aim is to illustrate a body in a simple manner, maintaining neutrality<br /> and inclusivity. We typically ask users two questions to determine their workout preferences and then filter the suggested<br /> videos accordingly, enhancing accessibility.</p>
        <img src="/quizEx.png" className={styles.quizEx} />
        <p className={styles.appOffersP}>The app offer a wide range of workout videos suitable for beginners, users with regular exercise routines, and advanced<br /> levels, with options for both equipment-based and equipment-free workouts. This also contributes to a high level of<br /> inclusivity and accessibility.</p>
        <div className={styles.lineTwo}></div>
        <h3 className={styles.images}>Images and Inspirations</h3>
        <p className={styles.imgP}> For the videos and images utilized throughout the app, we uphold the principle of inclusivity, aiming to encourage users<br /> with diverse exercise backgrounds to join and follow the workout videos. Therefore, we offer a variety of videos featuring<br /> male or female coaches, coaches in groups, and coaches of different ethnicities. </p>
        <div className={styles.gallery}>
          ...
          <img src="/yogaLadys.jpg" className={styles.img} />
          <img src="/yogaGirls.jpeg" className={styles.img} />
          <img src="/intermediate cardio_with glasses.jpeg" className={styles.img} />
        </div>
        <p className={styles.lastP}> As our app aims to deliver professional-quality workout videos, the majority of the videos are led by professional coaches<br /> who typically have well-toned bodies. This not only ensures professionalism but also serves as motivation for users to strive<br /> for better results.
        </p>
        <p className={styles.lastP}> However, some of the images used for thumbnails in the app are parent-friendly and feature individuals from different age<br /> groups and body shapes. This is intended to cultivate a friendly and welcoming environment for users from various backgrounds.
        </p>
      </main>
      <Footer />
    </>
