...
export default function Graphics() {
    return (
      ...
      <Header/>
        ...
        <p className={styles.homeP}>The Home button navigates users to the home screen, where they can access all main features of the app, including Daily Challenges, Workout Videos, Fitness Statistics,<br/> and Nutrition Tips. This button is expected to be the most frequently used by users, so it is located in the middle of the navigation bar and stands out slightly from<br/> the other icons.</p>
