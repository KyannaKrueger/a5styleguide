...
export default function Graphics() {
    return (
      ...
      <Header/>
        ...
        <p className={styles.appOffersP}>The app offer a wide range of workout videos suitable for beginners, users with regular exercise routines, and advanced<br/> levels, with options for both equipment-based and equipment-free workouts. This also contributes to a high level of inclusivity and accessibility.</p>
        <div className={styles.lineTwo}></div>
