...
export default function Graphics() {
    return (
      ...
      <Header/>
        ...
        <p className={styles.iconsExOne}>For the icons designed throughout the app, our aim is to illustrate a body in a simple manner, maintaining neutrality<br/> and inclusivity. We typically ask users two questions to determine their<br/> workout preferences and then filter the suggested videos accordingly, enhancing accessibility.</p>
