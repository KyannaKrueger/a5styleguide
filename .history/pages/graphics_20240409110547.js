...
export default function Graphics() {
    return (
      ...
      <Header/>
        ...
        <img src="/beginner_group.png" className={styles.imgOne}/>
        <img src="/home fitness image.jpeg" className={styles.imgTwo}/>
        <img src="/Yoga-for-the-weight-loss.jpg" className={styles.imgThree}/>
        <img src="/YogaLady.jpeg" className={styles.imgFour}/>
        <img src="/yogaGirls.jpeg" className={styles.imgFive}/>
        <img src="/intermediate cardio_with glasses.jpeg" className={styles.imgSix}/>
        </main>
        <Footer/>
      </>
    );
