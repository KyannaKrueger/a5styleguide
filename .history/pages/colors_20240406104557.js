        ...
        <main className={styles.colors}>
         ...
         <div className={styles.swatchContainer}>
              ...
              <div className={styles.clrSwatch}>
                  ...
                  <h4>The Grey</h4>
                  <p>This shade of grey is an excellent color choice<br/> to compliment out accent color. This color is primarily used for buttons, and stand out against our dark mode background.</p>
              </div>
              <div className={styles.clrSwatch}>
