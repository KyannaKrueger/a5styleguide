...
export default function Graphics() {
    return (
      ...
      <Header/>
        ...
        <p className={styles.workoutP}>The Rewards icon lets users navigate to the 'My Rewards' page, which features a rewards action button, users' achievements, and statistical records. This page serves as a summary of users' statistics, allowing them to overview their progress within the app. It acts as a motivational tool, encouraging users to monitor their results and redeem rewards.</p>
