        ...
        <main className={styles.colors}>
         ...
         <div className={styles.swatchContainer}>
              ...
              <div className={styles.clrSwatch}>
                  ...
                  <h4>The Black</h4>
                  <p>Black is our background color for dark mode, <br/>and our text color for light mode.</p>    
              </div>
         ...
         <p className={styles.description}>The following images are examples of where our main colors are used appropriately in the app.</p>
