      ...
      <Header/>
        <main className={styles.logoPage}>
            ...
            <div className={styles.variationsTxtContainer}>
                <p className={styles.variationsTxt}>Original logo on Dark mode</p>
                <p className={styles.variationsTxtThree}>Logo on Light mode</p>
                <p className={styles.variationsTxt}>Grayscale logo</p>
            </div>
