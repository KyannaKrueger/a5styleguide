...
export default function ref() {
    return (
      ...
      <Header/>
        ...
        <h3 className={styles.refHeadings}>Color from <a href="https://m2.material.io/design/color/dark-theme.html#behavior" className={styles.refLink}>Google Material Design</a>&nbsp&nbsp&nbsp&nbsp<a href="https://www.ux-republic.com/en/which-border-radius-to-adopt-for-your-cta-copy/" className={styles.refLink}>Verywell mind</a></h3>
        <h3 className={styles.refHeadings}>Buttons & Cards Design from <a href="https://www.ux-republic.com/en/which-border-radius-to-adopt-for-your-cta-copy/" className={styles.refLink}>Youtube</a><a href="https://www.ux-republic.com/en/which-border-radius-to-adopt-for-your-cta-copy/" className={styles.refLink}>Youtube</a></h3>
