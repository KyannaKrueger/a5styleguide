        ...
        <main className={styles.colors}>
         ...
         <div className={styles.swatchContainer}>
              ...
              <div className={styles.clrSwatchBlack}>
                  ...
                  <p>Pure black is a harsh color on the eyes, <br/> so we are substituting for a dark grey for our<br/> dark mode background, <br/>and our text color for light mode. Black also serves to<br/> highlight the vibrant orange color and has<br/> a large contrast.</p>    
              </div>
