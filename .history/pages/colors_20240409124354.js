        ...
        <main className={styles.colors}>
         ...
         <div className={styles.swatchContainer}>
              ...
              <div className={styles.clrSwatchBlack}>
                  ...
                  <p>Pure black is a harsh color on the eyes, <br/> so we are substituting for a dark grey for our<br/> dark mode background, and our text color for light mode.<br/> Dark grey also serves to highlight the vibrant orange<br/> color and has a large contrast.</p>    
              </div>
         ...
         <div className={styles.clrExamples}>
                <img src="/newClrExOne" className={styles.colorEx}/>
                <img src="/newClrExTwo" className={styles.colorEx}/>
                <img src="/newClrExThree" className={styles.colorEx}/>
          </div>
         ...
         <div className={styles.accessibleContainer}>
          ...
          <p className={styles.accessibleP}>NOTE: the orange on white button text<br/> font size will be 18pt or bold over 14pt<br/> to be more accessible.</p>
         </div>
        </main>
        <Footer/>
      </>
