...
export default function Graphics() {
    return (
      ...
      <Header/>
        ...
        <p>The design of buttons and cards throughout the app features rounded shapes, aligning with our goal to evoke a sense of friendliness and approachability. Beyond maintaining consistency, research indicates that rounded shapes offer a visually pleasing appearance and contribute to a modern and harmonious user experience.</p>
        <img src="/buttonImg">
        <p>Human eyes are naturally drawn to curves, making rounded buttons more prominent than straight lines. Additionally, rounded buttons are considered more inclusive and accessible to users with motor impairments because they are easier to recognize and help reduce the risk of accidental touches.</p>
        </main>
        <Footer/>
      </>
    );
