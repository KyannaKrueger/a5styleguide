    ...
    <>
      ...
      <main className={`${styles.main} ${inter.className}`}>
        <div className={styles.square}>
          <video className={styles.bgVideoContainer} autoPlay muted loop className={styles.backgroundVideo}>
            <source className={cover} src="/fitQuestSlideshow.mp4" type="video/mp4" />
          </video> 
        </div>
