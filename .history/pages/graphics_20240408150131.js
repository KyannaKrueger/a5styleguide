...
export default function Graphics() {
    return (
      ...
      <Header/>
        ...
        <p>The Settings button directs users to the settings page of the app, where they can adjust their preferences and customize their accessibility settings. The range of settings offers users a more accessible and inclusive user experience.</p>
        </main>
      </>
    );
  }
