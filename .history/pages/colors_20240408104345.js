        ...
        <main className={styles.colors}>
         ...
         <div className={styles.swatchContainer}>
              ...
              <div className={styles.clrSwatchBlack}>
                  ...
                  <p>Pure black is a harsh color on the eyes, <br/> so we are substituting for a dark grey for our<br/> dark mode background, and our text color for light mode.<br/> Dark grey also serves to highlight the vibrant orange<br/> color and has<br/> a large contrast.</p>    
              </div>
