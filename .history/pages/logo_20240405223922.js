      ...
      <Header/>
        <main className={styles.logoPage}>
            ...
            <div className={styles.variationsTxtContainer}>
                <h4 className={styles.variationsTxt}>Original logo on Dark mode</h4>
                <h4 className={styles.variationsTxt}>Logo on Light mode</h4>
                <h4 className={styles.variationsTxt}>Grayscale logo</h4>
            </div>
