    ...
    return (
      ...
      <Header/>
        <main className={styles.colors}>
         ...
         <p className={styles.acDescription}>The following images are screenshots displaying color contrast results.<br/>NOTE: the orange and white button text font size will be 18pt or bold over 14pt to be more accessible.</p>
        </main>
        <Footer/>
      </>
    );
