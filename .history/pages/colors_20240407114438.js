        ...
        <main className={styles.colors}>
         ...
         <div className={styles.swatchContainer}>
              ...
              <div className={styles.clrSwatchBlack}>
                  ...
                  <h4>The Black</h4>
                  <p>Black is our background color for dark mode, <br/>and our text color for light mode. Black also serves to<br/> highlight the vibrant orange color and has<br/> a large contrast.</p>    
              </div>
         ...
         <p className={styles.acDescription}>The following images are screenshots displaying color contrast results.<br/>NOTE: the orange and white button text font size will<br/> be 18pt or bold over 14pt to be more accessible.</p>
        </main>
        <Footer/>
      </>
    );
