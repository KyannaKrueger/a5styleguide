        ...
        <main className={styles.colors}>
         ...
         <div className={styles.swatchContainer}>
              <div className={styles.clrSwatch}>
                  ...
                  <h4>The Accent</h4>
                  <p>We selected orange as our accent color <br/> because it symbolizes energy, which is<br/> crucial for a fitness app. We opted for this vibrant shade of orange over other colors because its brightness distinguishes the app, serving as a powerful reminder and motivator for daily workouts.<br/> You can find this color in our action buttons and to highlight important parts of our app.</p>
              </div>
              <div className={styles.clrSwatch}>
