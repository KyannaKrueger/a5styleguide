...
export default function Graphics() {
    return (
      ...
      <Header/>
        ...
        <p>For the icons designed throughout the app, our aim is to illustrate a body in a simple manner, maintaining neutrality and inclusivity. We typically ask users two questions to determine their workout preferences and then filter the suggested videos accordingly, enhancing accessibility.</p>
        </main>
        <Footer/>
      </>
    );
